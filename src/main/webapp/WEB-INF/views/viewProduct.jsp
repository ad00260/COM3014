        ...
        <div class="container" ng-app="cartApp">
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <h4>
                        ${product.productPrice} GBP
                    </h4>
                    <br>

                    <!-- jstl set function to define variable, whole page !-->
                    ...
                    <!-- click on button link, goes back to specified url - admin goes back to product inventory, user goes back to product list !-->
