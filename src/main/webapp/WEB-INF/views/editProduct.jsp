...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <!-- extends whole field to cover the width of the container, input value after submit will be bind to product name of product !-->
